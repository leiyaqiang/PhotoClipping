...
public class SelectPicturePopupWindow extends PopupWindow implements View.OnClickListener {
    ...
    public SelectPicturePopupWindow(Context context) {
        ...
        takePhotoBtn = (TextView) mMenuView.findViewById(R.id.picture_selector_take_photo_btn);
        pickPictureBtn = (TextView) mMenuView.findViewById(R.id.picture_selector_pick_picture_btn);
        cancelBtn = (TextView) mMenuView.findViewById(R.id.picture_selector_cancel_btn);
        // 设置按钮监听
